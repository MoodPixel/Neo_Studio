...
| Thread Memory Engine | ✅ Embedding & Reranker Model Support | Added support for local embedding and reranker model integration inside **Memory → Thread Memory**. Users can now directly assign embedding model folders and reranker model folders for improved semantic retrieval, contextual grounding, and memory ranking workflows. |
