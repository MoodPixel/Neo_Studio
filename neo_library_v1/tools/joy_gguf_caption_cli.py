...
def main():
    ap = argparse.ArgumentParser(description="JoyCaption GGUF captioner (llama-cpp-python) — batch + single.")
    ap.add_argument("--model", required=True, help="Main GGUF model path (JoyCaption).")
