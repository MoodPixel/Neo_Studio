...
* 🎨 **Image Tab**
  ...
  * Supports ControlNet, ADetailer, and advanced pipelines
* 🧩 **Board**
...
* 🎭 **Roleplay System**
  ...
  * **Forge** – Create characters, worlds, and structured entities
  * **Scene** – Live roleplay and writing environment
  * **Stories** – Workspace, archive, and narrative management
  * **Studio** – Advanced configuration and system controls
* 🤖 **Assistant**

  * Chat-based workflow with memory and context support
* ⚙️ **Admin**

  * Launch and manage local backends (ComfyUI, KoboldCPP, etc.)
...
Neo Studio does **not include AI models or third-party backends**.
Users must install and configure their own tools separately.
