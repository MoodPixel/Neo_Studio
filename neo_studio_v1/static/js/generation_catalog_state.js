...
const generationWorkspacePresetApiPath = '/api/generation/workspace-presets';
let generationShellSnapshotsServerHydrated = false;
let generationShellSnapshotsServerSaveTimer = null;
let generationShellSnapshotsState = [];
let generationDefaultShellSnapshotIdState = '';
